...
- **Global scope**: `C:/Users/adars/Downloads/ARC_Studio/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/adars/Downloads/ARC_Studio/.claude/notes/`)
...
2. Glob `C:/Users/adars/Downloads/ARC_Studio/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/adars/Downloads/ARC_Studio/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/adars/Downloads/ARC_Studio/.claude/notes/` — works in any directory
